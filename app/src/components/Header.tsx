...
export default function Header({ book, chapter, version, isCompareMode, onToggleCompare, isDark = false, headerBg = 'bg-white/90 dark:bg-stone-900/90 backdrop-blur border-stone-200 dark:border-stone-700' }: Props) {
